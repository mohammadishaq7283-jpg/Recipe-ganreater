...
<head>
    ...
    <style>
        ...
        #splash-screen {
            ...
            background: var(--primary); /* Full Screen Red/Orange */
        ...
        .splash-title { font-size: 32px; font-weight: bold; margin-bottom: 10px; }
        ...
        /* --- MAIN APP --- */
        .app-container { padding: 20px; flex: 1; overflow-y: auto; display: none; /* Initially Hidden */ }
...
<body>
    ...
    <div id="splash-screen">
        <div class="splash-logo"><i class="fas fa-hat-chef"></i></div>
        <div class="splash-title">Pro AI Chef</div>
        <div class="splash-sub">Cooking Made Easy 🍳</div>
    </div>
